...
lvalue  : ID "[" rvalue "]"
        | ID 
        ;
consts  : NIL                   { proxyprint_const(NIL, yytext); }/* Literal  */
        | NUMCONST              { proxyprint_const(_NUMCONST, yytext); } 
        | STRCONST              { proxyprint_const(_STRCONST); } /* Literals ----- */
        | FLOATCONST            { proxyprint_const(_FLOATCONST); }
        ;
